...
#   finding number of items in list, sorting the list, adding/removing items,
#   copying the list of items into another list, and changing the data in the list.
...
def main():
     ...
     dogs.append("Ranger")
     print("\nAdd a dog name to the end of a list, using append():")
     print(dogs)
     pause()
     ...
     print("\nRemove a dog off from position 3 (the 4th dog) in the list, using pop(index-here):")
     print(dogs)
     print(doggy + " was removed from position 3 of the list.")
     pause()
